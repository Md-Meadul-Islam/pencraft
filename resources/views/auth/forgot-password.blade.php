...
<head>
    ...
    <title>Forgot Password || PenCraft</title>
    <link rel="apple-touch-icon" href="{{asset('frontend')}}/img/apple-touch-icon.png">
    <link rel="icon" type="image/gif" href="{{asset('frontend')}}/img/logo.png">
              ...
              <div class="col-lg-4 col-md-8 col-sm-10 d-flex flex-column align-items-center justify-content-center">
                <div class="d-flex justify-content-center py-4">
                  <a href="{{route('welcome')}}" class="d-flex align-items-center w-auto" style="text-decoration: none">
                    <img src="{{asset('frontend')}}/img/logo.png" width="50px" height="50px"><span class="d-lg-block" style="font-weight:800;font-size:36px;color:#81c408">PenCraft</span></a>
                </div><!-- End Logo -->
                <div class="card mb-3">
